...
# Custom implementation of repeat function
...
class MusicPlayer(EventEmitter, Serializable):
    ...
    # Repeat implementation works by cycling through options
    # TODO: Allow user specification of mode
    def repeat(self):
        ...
        raise ValueError('Cannot repeat a MusicPlayer in state %s' % self.state)
